    ...
    <header className="shadow-card-value fixed top-0 z-50 w-full bg-white">
      ...
      >
        <div className="flex lg:flex-1">
          <Link href="/" className="relative -m-1.5 h-[40px] w-[62px]">
            <span className="sr-only">DTH</span>
            <Image fill={true} src="/images/logo.png" alt="DTH Logo" />
          </Link>
        </div>
        ...
        <div className="flex flex-1 justify-end">
          <Button
            variant="contained"
            className="flex h-[32px] w-full !max-w-[100px] items-center justify-center gap-x-1 !rounded-[50px] !bg-[#66B066] text-sm/6 !normal-case text-white"
            onClick={() =>
